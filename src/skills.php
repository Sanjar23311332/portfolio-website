...
<body>
    <?php
        ...
        if(isset($_POST['update'])){
            ...
            $skills_id = $array['count'];
            for($i = 1; $i <= $skills_id; $i++){
                $skills_desc = $_POST[$i];
                $query = "UPDATE skills SET skills_desc = '$skills_desc' WHERE id = '$i'";
                mysql_query($query);
            }
          ...
          <?php 
            ...
            function skills(){
                    ...
                    while($array = mysql_fetch_assoc($result)){
                        ...
                        $skills_id = $array['id'];
                        ?>
                        <label for="<?php echo $skills_id ?>"><?php echo $skill ?></label>
                        <textarea name="<?php echo $skills_id ?>" class="form-control" id="<?php echo $skills_id ?>"><?php echo $skills_desc?></textarea>
                <?php }
            }
            ?>
              </div>
